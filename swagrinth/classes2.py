...
def obj_build(obj, input_data: dict, blueprint_plan: dict, corrections = {}):
    '''
    ...
    obj              -- The object in question, what the attributes will be set on
    ...
    # Set attributes
    for item in blueprint:
        setattr(obj, item, blueprint[item])

    # Save the reference to the blueprint given, makes building a payload a brazilian times easier
    obj._blueprint_plan = blueprint_plan


def obj_payload(obj): pass
...
class User():
    ...
    def __init__(self, **args):
        obj_build(self, args, BP_USER, FIX_USER)
...
class TeamMember():
    ...
    '''
    def __init__(self, **args):
        obj_build(self, args, BP_TEAM_MEMBER, FIX_TEAM_MEMBER)
...
class Notification():
    ...
    '''
    def __init__(self, **args):
        obj_build(self, args, BP_NOTIFICATION)
...
class Project():
    ...
    '''
    def __init__(self, **args):
        obj_build(self, args, BP_PROJECT, FIX_PROJECT)
...
class DonationSite():
    ...
    '''
    def __init__(self, **args):
        obj_build(self, args, BP_DONATION_SITE)
...
class ModMessage():
    ...
    '''
    def __init__(self, **args):
        obj_build(self, args, BP_MOD_MESSAGE)
...
class Image():
    ...
    '''
    def __init__(self, **args):
        obj_build(self, args, BP_IMAGE, FIX_IMAGE)
...
class License():
    def __init__(self, **args):
        obj_build(self, args, BP_LICENSE)


class ProjectListing():
    def __init__(self, **args):
        obj_build(self, args, BP_PROJECT_LISTING)
...
class SearchResult():
    def __init__(self, **args):
        obj_build(self, args, BP_SEARCH_RESULT)
...
class Version():
    ...
    '''
    def __init__(self, **args):
        obj_build(self, args, BP_VERSION, FIX_VERSION)
...
class VersionFile():
    ...
    '''
    def __init__(self, **args):
        obj_build(self, args, BP_VERSION_FILE, FIX_VERSION_FILE)
...
class Dependency():
    ...
    '''
    def __init__(self, **args):
        obj_build(self, args, BP_DEPENDENCY, FIX_DEPENDENCY)
...
class DependencyList():
    ...
    '''
    def __init__(self, **args):
        obj_build(self, args, BP_DEPENDENCY_LIST)
